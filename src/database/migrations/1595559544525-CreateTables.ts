...
export class CreateTables1595559544525 implements MigrationInterface {
    name = 'CreateTables1595559544525'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "type_exams" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_11dd9b1e0599179bd38adffdc72" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "exams" ("id" SERIAL NOT NULL, "description" character varying NOT NULL, "code" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "typeExamId" integer, CONSTRAINT "PK_b43159ee3efa440952794b4f53e" PRIMARY KEY ("id"))`);
