...
export class CreateTables1595623657509 implements MigrationInterface {
    name = 'CreateTables1595623657509'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "address" ADD CONSTRAINT "FK_b0a0d4d9a2ccac574afbb791645" FOREIGN KEY ("pacientId") REFERENCES "pacients"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
