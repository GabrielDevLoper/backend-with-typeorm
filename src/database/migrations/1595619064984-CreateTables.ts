...
export class CreateTables1595619064984 implements MigrationInterface {
    name = 'CreateTables1595619064984'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "pacients" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "pront_req_interno" character varying NOT NULL, "convenio" character varying NOT NULL, "procedencia" character varying NOT NULL, "medico_solicitante" character varying NOT NULL, "fone" character varying NOT NULL, "data_entrega" character varying DEFAULT 'Sem data definida', "status" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer, CONSTRAINT "PK_efd730c17958fa5e57267dec081" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "address" ("id" SERIAL NOT NULL, "street" character varying, "city" character varying, "uf" character varying, "neighborhood" character varying, "zipcode" character varying, "pacientId" integer, CONSTRAINT "REL_b0a0d4d9a2ccac574afbb79164" UNIQUE ("pacientId"), CONSTRAINT "PK_d92de1f82754668b5f5f5dd4fd5" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "address" ADD CONSTRAINT "FK_b0a0d4d9a2ccac574afbb791645" FOREIGN KEY ("pacientId") REFERENCES "pacients"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "address" DROP CONSTRAINT "FK_b0a0d4d9a2ccac574afbb791645"`);
